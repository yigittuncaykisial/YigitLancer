...
{
    /// <inheritdoc />
    public partial class ChaAndPurchaseReq : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conversations_Users_FreelancerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseRequests_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_FreelancerUserId",
                table: "Conversations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequests_JobId",
                table: "PurchaseRequests",
                column: "JobId");
        }
